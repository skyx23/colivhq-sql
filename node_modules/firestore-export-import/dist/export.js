...
data[collectionName][doc.id]['subCollection']={};_f=0,subCollections_1=subCollections;_g.label=7;case 7:if(!(_f<subCollections_1.length))return[3,10];subCol=subCollections_1[_f];return[4,exports.backup(collectionName+"/"+doc.id+"/"+subCol.id,options)];case 8:subColData=_g.sent();data[collectionName][doc.id]['subCollection']=addElement(data[collectionName][doc.id]['subCollection'],subColData);_g.label=9;case 9:_f++;return[3,7];case 10:_i++;return[3,5];case 11:return[2,data];case 12:error_1=_g.sent();console.error(error_1);throw new Error(error_1);case 13:return[2];}});});};exports.backup=backup;